...
const char isWATER = 126; //ASCII Character Code
const char isHIT = 64;
const char isSHIP = 62;
const char isMISS = 'X';
...
int main()
{
	...
	cout<<"Bir Mod Seciniz :"<<endl;
	cout<<"1-) PC' ye karsi."<<endl;
	cout<<"2-) 1-1 Player."<<endl;
	cin>>secim;
	if(secim==1)
	{
    ...
    for (int aplyr=1; aplyr<3; ++aplyr)
    {
        ...
        if(aplyr == 1){
            ...
            cout<<"Player " << aplyr <<" Placement Done! \n";
        } else{
            cout<<"Computer Placement...! \n";
            cout<<"Computer Placement Done! \n";
        }
...
PLACESHIPS ComputersPlacement()
{
    ...
    //Using this as a bad return
    tmp.shipType.onGrid[0].X = -1;
    //Get random 3 integers from Computer
    //srand (time(NULL));
    d = rand() % 2;
    x = rand() % 9;
    y = rand() % 9;
